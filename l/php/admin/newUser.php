...
<input type="text" name="name" id="inputName" class="form-control" value="" required="required" pattern="" title=""><br>
		...
		<label for="inputPassword" class="col-sm-2">Password: </label>
			<input type="text" name="password" id="inputPassword" class="form-control" value="" required="required" pattern="" title=""><br>
		</div>
		<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
	...
	<div class="row">
		...
		<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
			...
			<button style="float:right;" type="button" onclick="newUser();" class="btn btn-success">Save</button>
		</div>
